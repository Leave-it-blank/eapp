        ...
        <div class="flex flex-row justify-center mx-auto w-full border border-gray-200 rounded-2xl">
            <div class="h-[860px] relative w-full max-w-xl mx-auto md:w-2/3 xl:w-1/2   bg-white -500 rounded-l-2xl flex flex-col justify-center items-center">
                ...
                <div  class="py-10 ">
                    ...
                    <div>  <small class="text-sm">Already Have an account? <a class="text-lime-600 capitalize" href="{{ route('login') }}"> login</a></small></div>
                </div>
                <x-validation-errors class="mb-4 text-left w-full px-5 sm:px-10" />
                <div class=" flex flex-row w-full px-4 ">

                    <form class="w-full px-4" method="POST" action="{{ route('register') }}">
                        @csrf

                        <div>

                            <x-input placeholder="Full Name" id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                        </div>

                        <div class="mt-4">

                            <x-input placeholder="Email Address" id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
                        </div>
                        ...
                        <div class="flex flex-col items-center justify-center mt-4">
                            ...
                            <a class="underline mt-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('login') }}">
                                {{ __('Already registered?') }}
                            </a>
                        </div>
            ...
            <div class="h-[860px] bg-lime-500 hidden md:block md:w-2/3 xl:w-1/2 rounded-r-2xl" style="background-image: url('Landing_Page/auth.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;">
